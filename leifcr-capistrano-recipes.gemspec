...
Gem::Specification.new do |s|
  s.name = "leifcr-capistrano-recipes"
  s.version = "0.9.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Phil Misiowiec", "Leonardo Bighetti", "Rogerio Augusto", "Leif Ringstad"]
  s.date = "2013-04-04"
  ...
  s.files = [
    ...
    "leifcr-capistrano-recipes.gemspec",
  ...
  s.homepage = "http://github.com/leifcr/capistrano-recipes"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<capistrano>, [">= 2.14.2"])
      ...
      s.add_dependency(%q<capistrano>, [">= 2.14.2"])
